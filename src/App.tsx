...
const App = () => {
  ...
  const settingsStateBoolean = [settingsOpened, isDarkMode, isAutoResume, isSoundOn, areNotificationsOn];
  const settingsStateNumbers = [focusTime[0], numberOfPomodoros, shortBreakTime[0], longBreakTime[0]];
  const settingsHandlersBoolean = [toggleDarkMode, toggleAutoResume, toggleSound, toggleNotifications];
  const settingsHandlersNumbers = [onSetFocusTime, onSetNumberOfPomodoros, onSetShortBreakTime, onSetLongBreakTime];
